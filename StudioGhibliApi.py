...
import json
import sys
from APIdatahandler.apidatahandler import ApiDataHandler
...
if __name__ == '__main__':
    ...
    try:
        ...
        object_to_fetch_data.jsontosheets(json_data=data, file_format='csv', filename='ghibliStudioApi_csv.csv',
                                          encoding='utf-8-sig', index=False, )
        object_to_fetch_data.jsontosheets(json_data=data, file_format='excel', filename='ghibliStudioApi_xl.xlsx',
                                          encoding='utf-8-sig', index=False, )
        object_to_fetch_data.jsontosheets(json_data=data, file_format='xml', filename='ghibliStudioApi_xml.xml',
        ...
        object_to_fetch_data.jsontohtml(json_data=data,
                                        ...
                                        render_links=True, classes="table table-striped table-bordered "
        ...
        object_to_fetch_data.htmltopdf(html_file='ghibliStudioApi_html.html', pdf_file='ghibliStudioApi_pdf.pdf',
